...
def download_img(url=''):
    ...
    try:
        ...
        return 'Required image was successfully downloaded!'
    
    except Exception as _ex:
        return 'Wooopsi... Something wrong, please check the URL please!'
...
def download_video(url=''):
    ...
    try:    
        ...
        return 'Required video was successfully downloaded!'
